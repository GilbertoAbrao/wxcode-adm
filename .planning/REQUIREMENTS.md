...
- [x] **DS-03**: App shell layout with sidebar navigation, responsive design, and dark mode enforced
...
- [x] **AUI-03**: User sees email verification page and can enter 6-digit OTP code after signup
- [x] **AUI-04**: User can request password reset via email and set new password via reset link
...
- [x] **TMI-02**: Owner/Admin can change member roles or remove members
- [x] **TMI-03**: Owner can enable/disable MFA enforcement for the tenant
...
- [x] **BUI-03**: User can access Stripe Customer Portal for payment method and invoice management

### Super-Admin UI

- [x] **SAI-01**: Admin can log in via separate admin login page with admin-audience JWT
- [x] **SAI-02**: Admin can view paginated tenant list with filters (plan, status) and suspend/reactivate tenants
- [x] **SAI-03**: Admin can search users by email, view details, and block/unblock users
...
| AUI-03 | Phase 13 | Complete |
| AUI-04 | Phase 13 | Complete |
...
| SAI-02 | Phase 17 | Complete |
| SAI-03 | Phase 17 | Complete |
