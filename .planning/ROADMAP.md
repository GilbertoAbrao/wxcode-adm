...
Plans:
- [x] 16-01-PLAN.md — Billing hooks (useBilling.ts), billing page layout, current subscription display, plan catalog with plan cards (GlowButton CTAs)
- [x] 16-02-PLAN.md — Stripe Checkout redirect flow, Customer Portal redirect, subscription status polling after checkout return
